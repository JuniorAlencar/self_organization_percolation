...
def _sample_data_dir(
    ...
    path = (
        Path(data_root)
        / _data_folder_for_mode_and_control(run_mode, control_rule)
...
def get_missing_run_parameters(
    *,
    ...
    surface_observables_arg = _normalize_bool_input(surface_observables, "surface_observables")
    save_animation_window_only_arg = _normalize_bool_input(
...
def run_multi_rho_array(
    ...
    extra_submit_args = _optional_submit_args(
        properties_arg=properties_arg,
        run_mode_arg=run_mode_arg,
        initial_layout_arg=initial_layout_arg,
